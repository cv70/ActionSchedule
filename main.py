...
from fetcher import fetch_hacknews_storys, fetch_huggingface_papers, fetch_techcrunch_rss, fetch_github_trending, fetch_arxiv_papers
from output import send_email, build_html_content
from llm import analize_datas
...
def main():
    ...
    # 洞察信息生成
    report = analize_datas(all_articles)
